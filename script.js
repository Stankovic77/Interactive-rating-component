...
function buttonClick1() {
  ...
  rating1.style.backgroundColor = "#fafafa";
  rating1.style.color = "#2a3035";
...
function buttonClick2() {
  const rating2 = document.querySelector(".rating2");
  rating2.style.backgroundColor = "#fafafa";
  rating2.style.color = "#2a3035";
...
function buttonClick3() {
  const rating3 = document.querySelector(".rating3");
  rating3.style.backgroundColor = "#fafafa";
  rating3.style.color = "#2a3035";
...
function buttonClick4() {
  const rating4 = document.querySelector(".rating4");
  rating4.style.backgroundColor = "#fafafa";
  rating4.style.color = "#2a3035";
